...
def load_data_fashion_mnist(batch_size,root="~/.mxnet/datasets/fashion-mnist"):
    mnist_train = gdata.vision.FashionMNIST(root = root,train=True, transform=transform)
    mnist_test = gdata.vision.FashionMNIST(root = root,train=False, transform=transform)
